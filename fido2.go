...
/*
#cgo darwin,amd64 CFLAGS: -I${SRCDIR}/dist/darwin-amd64/include -I/usr/local/opt/openssl@1.1/include
#cgo darwin,amd64 LDFLAGS: -framework CoreFoundation -framework IOKit ${SRCDIR}/dist/darwin-amd64/lib/libcbor.a ${SRCDIR}/dist/darwin-amd64/lib/libfido2.a /usr/local/opt/openssl@1.1/lib/libcrypto.a
